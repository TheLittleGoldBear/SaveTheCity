...
{
	public class Collision2DRelay : AbstractRelay
	{
		#region Events

		public event Action<UnityEngine.Collision2D> CollisionEnter2D;
		public event Action<UnityEngine.Collision2D> CollisionStay2D;
		public event Action<UnityEngine.Collision2D> CollisionExit2D;
		...
		protected virtual void OnCollisionEntered2D(UnityEngine.Collision2D collision2D)
		{ }

		protected virtual void OnCollisionStaying2D(UnityEngine.Collision2D collision2D)
		{ }

		protected virtual void OnCollisionExited2D(UnityEngine.Collision2D collision2D)
		{ }

		protected virtual bool CheckConditions(UnityEngine.Collision2D collision2D)
		{
			return true;
		}
		...
		private void NotifyOnCollisionEnter2D(UnityEngine.Collision2D collision2D)
		{
			CollisionEnter2D?.Invoke(collision2D);
		}

		private void NotifyOnCollisionStay2D(UnityEngine.Collision2D collision2D)
		{
			CollisionStay2D?.Invoke(collision2D);
		}

		private void NotifyOnCollisionExit2D(UnityEngine.Collision2D collision2D)
		{
